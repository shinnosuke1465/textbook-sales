<div class="font-weight-bold text-center" style="font-size: 24px">{{ $item->name }}</div>

<div class="row">
    <div class="col-4 offset-1">
        <x-thumbnail :filename="$item->image_file_name" type="products" class="card-img-top" />
    </div>
    <div class="col-6">
        <table class="table table-bordered">
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ asset('storage/images/' . $item->seller->avatar_file_name) }}" class="rounded-circle"
